        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
            {[
              {
                tag: "POS Algorithm",
                title: "Wang et al. — Algorithmic Principles of rPPG",
                source: "IEEE TBME, 2017",
                desc: "Primary heart rate extraction method used in our pipeline",
                url: "https://ieeexplore.ieee.org/document/7565547",
              },
              {
                tag: "CHROM",
                title: "De Haan & Jeanne — Robust Pulse Rate from Chrominance",
                source: "IEEE TBME, 2013",
                desc: "Secondary chrominance-based rPPG signal extraction",
                url: "https://ieeexplore.ieee.org/document/9983619",
              },
              {
                tag: "Benchmark",
                title: "UBF-rPPG — Multi-Dataset Evaluation Framework",
                source: "Université de Bourgogne",
                desc: "Standardized benchmarking for remote photoplethysmography algorithms",
                url: "https://sites.google.com/view/ybenezeth/ubfcrppg",
              },
              {
                tag: "Web rPPG",
                title: "UW Ubicomp Lab — Browser-Based Vital Signs",
                source: "University of Washington",
                desc: "Real-time webcam physiological measurement research",
                url: "https://github.com/ubicomplab/rppg-web",
              },
              {
                tag: "Review",
                title: "rPPG State-of-the-Art Review",
                source: "PMC / NIH, 2024",
                desc: "Comprehensive review of remote photoplethysmography methods and applications",
                url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC11362249/",
              },
              {
                tag: "Deep Learning",
                title: "Neural rPPG — Deep Learning Approaches",
                source: "NeurIPS 2023",
                desc: "Datasets and benchmarks for neural network-based rPPG",
                url: "https://proceedings.neurips.cc/paper_files/paper/2023/hash/d7d0d548a6317407e02230f15ce75817-Abstract-Datasets_and_Benchmarks.html",
              },
              {
                tag: "Philips IP",
                title: "Philips — Biosensing by rPPG",
                source: "Philips Innovation",
                desc: "Industrial-grade remote vital signs measurement technology",
                url: "https://www.philips.com/a-w/about/innovation/ips/ip-licensing/programs/biosensing-by-rppg.html",
              },
              {
                tag: "Avatars",
                title: "UCLA — rPPG with Synthetic Avatars",
                source: "Visual Computing Lab, UCLA",
                desc: "Remote physiological measurement using generated faces",
                url: "https://visual.ee.ucla.edu/rppg_avatars.htm/",
              },
            ].map((ref) => (
              <a
                key={ref.tag}
                ...
                className="flex items-start gap-3 p-3 rounded-xl transition-all duration-300 hover:scale-[1.01] group"
                style={{
              ...
              >
                <div
                  className="shrink-0 px-2 py-0.5 rounded text-[9px] font-mono font-bold uppercase tracking-wider mt-0.5"
                  style={{ background: "rgba(78,205,196,0.1)", color: "rgba(78,205,196,0.7)" }}
                >
                  {ref.tag}
                </div>
                <div className="flex flex-col gap-0.5 min-w-0">
                  <div className="text-xs text-white/80 font-medium leading-tight group-hover:text-cyan-300/90 transition-colors">{ref.title}</div>
                  <div className="text-[10px] font-mono text-cyan-400/40">{ref.source}</div>
                  <div className="text-[10px] text-gray-500 leading-snug">{ref.desc}</div>
                </div>
              </a>
            ))}
          </div>
